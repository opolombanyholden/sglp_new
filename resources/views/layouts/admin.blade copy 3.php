...
<body>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                            ...
                            <ul class="nav-list">
                                <li class="nav-item">
                                    <a href="{{ route('admin.geolocalisation.departements.index') }}" class="nav-link-custom {{ request()->routeIs('admin.geolocalisation.departements.*') ? 'active' : '' }}">
                                        ...
                                        <span class="nav-badge info">{{ \App\Models\Departement::count() ?? 0 }}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                    ...
                    <!-- NIVEAU 3 URBAIN : COMMUNES/VILLES -->
                    <div class="geo-section">
                        ...
                        <div class="geo-subsection" id="geo-communes" style="display: none;">
                            <ul class="nav-list">
                                <li class="nav-item">
                                    <a href="{{ route('admin.geolocalisation.communes_villes.index') }}" class="nav-link-custom {{ request()->routeIs('admin.geolocalisation.communes_villes.*') ? 'active' : '' }}">
                                        <i class="nav-icon fas fa-list"></i>
                                        <span class="nav-text">Liste Communes/Villes</span>
                                        <span class="nav-badge warning">{{ \App\Models\CommuneVille::count() ?? 0 }}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.geolocalisation.communes_villes.create') }}" class="nav-link-custom">
                                        <i class="nav-icon fas fa-plus"></i>
                            ...
                            <ul class="nav-list">
                                <li class="nav-item">
                                    <a href="{{ route('admin.geolocalisation.arrondissements.index') }}" class="nav-link-custom {{ request()->routeIs('admin.geolocalisation.arrondissements.*') ? 'active' : '' }}">
                                        ...
                                        <span class="nav-badge users">{{ \App\Models\Arrondissement::count() ?? 0 }}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                            ...
                            <ul class="nav-list">
                                <li class="nav-item">
                                    <a href="{{ route('admin.geolocalisation.cantons.index') }}" class="nav-link-custom {{ request()->routeIs('admin.geolocalisation.cantons.*') ? 'active' : '' }}">
                                        ...
                                        <span class="nav-badge roles">{{ \App\Models\Canton::count() ?? 0 }}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                            ...
                            <ul class="nav-list">
                                <li class="nav-item">
                                    <a href="{{ route('admin.geolocalisation.regroupements.index') }}" class="nav-link-custom {{ request()->routeIs('admin.geolocalisation.regroupements.*') ? 'active' : '' }}">
                                        ...
                                        <span class="nav-badge permissions">{{ \App\Models\Regroupement::count() ?? 0 }}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                            ...
                            <ul class="nav-list">
                                <li class="nav-item">
                                    <a href="{{ route('admin.geolocalisation.localites.index') }}" class="nav-link-custom {{ request()->routeIs('admin.geolocalisation.localites.*') ? 'active' : '' }}">
                                        ...
                                        <span class="nav-badge info">{{ \App\Models\Localite::count() ?? 0 }}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.geolocalisation.localites.index') }}?type=quartier" class="nav-link-custom">
                                        ...
                                        <span class="nav-badge warning">{{ \App\Models\Localite::where('type', 'quartier')->count() ?? 0 }}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.geolocalisation.localites.index') }}?type=village" class="nav-link-custom">
                                        ...
                                        <span class="nav-badge success">{{ \App\Models\Localite::where('type', 'village')->count() ?? 0 }}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                    ...
                    <ul class="nav-list">
                        <li class="nav-item">
                            <a href="{{ route('admin.roles.index') }}" class="nav-link-custom {{ request()->routeIs('admin.roles.*') ? 'active' : '' }}">
                                ...
                                <span class="nav-badge roles">{{ \App\Models\Role::count() ?? 0 }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.permissions.index') }}" class="nav-link-custom {{ request()->routeIs('admin.permissions.*') ? 'active' : '' }}">
                                ...
                                <span class="nav-badge permissions">{{ \App\Models\Permission::count() ?? 0 }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
    ...
    <script>
        ...
        function geoGlobalSearch() {
            ...
            if (searchTerm) {
                window.location.href = `{{ route('admin.api.admin.geolocalisation.global-search') }}?q=${encodeURIComponent(searchTerm)}`;
            }
        }
        ...
        // ✅ AJAX pour mise à jour des compteurs en temps réel
        function updateGeoCounts() {
            $.get('{{ route("admin.api.admin.stats.realtime") }}', function(data) {
                if (data.geo) {
                ...
                console.log('Erreur lors de la mise à jour des compteurs géographiques');
            });
        }

        // Mise à jour des compteurs toutes les 5 minutes
