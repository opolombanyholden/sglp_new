...
<body>
    <div class="admin-layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <!-- NOUVELLE SECTION : RÔLES & PERMISSIONS -->
                <div class="nav-section">
                ...
                {{-- À ajouter dans la sidebar navigation existante --}}
                <li class="nav-item">
                    <a class="nav-link collapsed" 
                    href="#" 
                    data-bs-toggle="collapse" 
                    data-bs-target="#collapseGeolocalisation" 
                    aria-expanded="false"
                    aria-controls="collapseGeolocalisation">
                    ...
                    <div class="collapse {{ request()->routeIs('admin.geolocalisation.*') ? 'show' : '' }}" 
                        id="collapseGeolocalisation">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link {{ request()->routeIs('admin.geolocalisation.provinces.*') ? 'active' : '' }}" 
                            href="{{ route('admin.geolocalisation.provinces.index') }}">
                                <div class="sb-nav-link-icon">
                                    <i class="fas fa-map-marked-alt"></i>
                                </div>
                                Provinces
                            </a>
                            <a class="nav-link {{ request()->routeIs('admin.geolocalisation.departements.*') ? 'active' : '' }}" 
                            href="{{ route('admin.geolocalisation.departements.index') }}">
                                <div class="sb-nav-link-icon">
                                    <i class="fas fa-building"></i>
                                </div>
                                Départements
                            </a>
                            <a class="nav-link {{ request()->routeIs('admin.geolocalisation.communes.*') ? 'active' : '' }}" 
                            ...
                            <a class="nav-link {{ request()->routeIs('admin.geolocalisation.cantons.*') ? 'active' : '' }}" 
                            href="#" onclick="event.preventDefault()">
                                <div class="sb-nav-link-icon">
                            ...
                            <a class="nav-link {{ request()->routeIs('admin.geolocalisation.localites.*') ? 'active' : '' }}" 
                            href="#" onclick="event.preventDefault()">
                                <div class="sb-nav-link-icon">
    ...
    <script>
        $(document).ready(function() {
            console.log('SGLP Admin Layout - Design final chargé avec Rôles & Permissions');
