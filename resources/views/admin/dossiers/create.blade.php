...
@section('content')
    <div class="dossier-form-wrapper">
        ...
        <div class="container-fluid py-4">
                ...
                <div class="hero-content">
                    <div class="hero-title-group">
                        ...
                        <div class="hero-text">
                            ...
                            <p>Création d'une organisation en 7 étapes</p>
                        </div>
                    </div>
            ...
            <form id="createDossierForm" method="POST" action="{{ route('admin.dossiers.store') }}"
                        ...
                        <div class="accordion accordion-modern" id="accordionDossier">
                            ...
                            <div class="accordion-item" id="itemType">
                                <div class="accordion-header">
                                    <button class="accordion-trigger" type="button" data-bs-toggle="collapse"
                                ...
                                <div id="collapseType" class="accordion-collapse collapse show"
                                    data-bs-parent="#accordionDossier">
                                            ...
                                            @foreach($typesOrganisation as $type)
                                                <label class="type-option" id="typeCard{{ $type->id }}">
                                                    <input type="radio" name="organisation_type_id" value="{{ $type->id }}"
                                                        ...
                                                        data-code="{{ $type->code }}"
                                                        {{ old('organisation_type_id') == $type->id ? 'checked' : '' }}>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <button class="accordion-trigger collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseDeclarant" aria-expanded="false">
                                        <div class="accordion-trigger-content">
                                        ...
                                        <div class="form-grid">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-input-modern" name="demandeur_nip"
                                                    id="demandeur_nip" value="{{ old('demandeur_nip') }}" required
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select-modern" name="demandeur_civilite"
                                                    ...
                                                    <option value="M"
                                                        {{ old('demandeur_civilite') == 'M' ? 'selected' : '' }}>Monsieur
                                                    </option>
                                                    <option value="Mme"
                                                        {{ old('demandeur_civilite') == 'Mme' ? 'selected' : '' }}>Madame
                                                    </option>
                                                    <option value="Mlle"
                                                        {{ old('demandeur_civilite') == 'Mlle' ? 'selected' : '' }}>
                                                        Mademoiselle</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-input-modern" name="demandeur_nom"
                                                    id="demandeur_nom" value="{{ old('demandeur_nom') }}" required
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-input-modern" name="demandeur_email"
                                                    id="demandeur_email" value="{{ old('demandeur_email') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select-modern" name="demandeur_role"
                                                    id="demandeur_role">
                                                    <option value="Déclarant">Déclarant</option>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <button class="accordion-trigger collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseOrganisation" aria-expanded="false">
                                        <div class="accordion-trigger-content">
                                        ...
                                        <div class="form-grid">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-input-modern" name="org_sigle" id="org_sigle"
                                                    value="{{ old('org_sigle') }}" placeholder="Ex: ASBL, ONG...">
                                            </div>
                                            <div class="form-group span-3">
                                                ...
                                                <textarea class="form-textarea-modern" name="org_objet" id="org_objet"
                                                    rows="3" required
                                                    placeholder="Description des activités et objectifs...">{{ old('org_objet') }}</textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-input-modern" name="org_email"
                                                    id="org_email" value="{{ old('org_email') }}"
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <button class="accordion-trigger collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseLocalisation" aria-expanded="false">
                                        <div class="accordion-trigger-content">
                                ...
                                <div id="collapseLocalisation" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-content">
                                        ...
                                        <input type="hidden" name="ville_commune" id="commune_nom">
                                            ...
                                            <div class="zone-options">
                                                <label class="zone-option">
                                                    <input type="radio" name="zone_type" value="urbaine"
                                                        {{ old('zone_type', 'urbaine') == 'urbaine' ? 'checked' : '' }}>
                                                    <div class="zone-card">
                                        ...
                                        <div class="form-grid">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-input-modern" name="org_lieu_dit"
                                                    id="org_lieu_dit" value="{{ old('org_lieu_dit') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-input-modern" name="org_sous_prefecture"
                                                    id="org_sous_prefecture" value="{{ old('org_sous_prefecture') }}"
                                            ...
                                            <div class="form-group span-2">
                                                ...
                                                <input type="text" class="form-input-modern" name="org_adresse"
                                                    id="org_adresse" value="{{ old('org_adresse') }}" required
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-input-modern" name="org_latitude"
                                                    id="org_latitude" value="{{ old('org_latitude') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-input-modern" name="org_longitude"
                                                    id="org_longitude" value="{{ old('org_longitude') }}"
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <button class="accordion-trigger collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseFondateurs" aria-expanded="false">
                                        <div class="accordion-trigger-content">
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <button class="accordion-trigger collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseMembresBureau" aria-expanded="false">
                                        <div class="accordion-trigger-content">
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <button class="accordion-trigger collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseAdherents" aria-expanded="false">
                                        <div class="accordion-trigger-content">
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    function updateStepper(sectionId) {
                        var stepMap = { 'collapseType': 1, 'collapseDeclarant': 2, 'collapseOrganisation': 3, 'collapseLocalisation': 4, 'collapseFondateurs': 5, 'collapseMembresBureau': 6, 'collapseAdherents': 7, 'collapseDocuments': 8 };
                            ...
                            function updateDocuments(config) {
                                ...
                                if (docsObl.length > 0) {
                                    ...
                                    docsObl.forEach(function (doc) {
                                        ...
                                        html += '</div>';
                                        html += '<input type="file" class="form-input-modern" name="documents[' + doc.id + ']" required>';
                                        html += '</div>';
                                    });
                                }
                                if (docsFac.length > 0) {
                            ...
                            document.getElementById('org_province_id').addEventListener('change', function () {
                                var id = this.value;
                            ...
                            document.getElementById('org_departement_id').addEventListener('change', function () {
                                var id = this.value;
                                var selectedOption = this.options[this.selectedIndex];
                            ...
                            document.getElementById('org_commune_id').addEventListener('change', function () {
                                var id = this.value;
                                var selectedOption = this.options[this.selectedIndex];
                            ...
                            document.getElementById('org_arrondissement_id').addEventListener('change', function () {
                                var id = this.value;
                                var selectedOption = this.options[this.selectedIndex];
                            ...
                            document.getElementById('org_quartier_id').addEventListener('change', function () {
                                var selectedOption = this.options[this.selectedIndex];
                            ...
                            document.getElementById('org_canton_id').addEventListener('change', function () {
                                var id = this.value;
                                var selectedOption = this.options[this.selectedIndex];
                            ...
                            document.getElementById('org_regroupement_id').addEventListener('change', function () {
                                var id = this.value;
                                var selectedOption = this.options[this.selectedIndex];
                            ...
                            document.getElementById('org_village_id').addEventListener('change', function () {
                                var selectedOption = this.options[this.selectedIndex];
                            ...
                            // Fondateurs
                            document.getElementById('btnAddFondateur').addEventListener('click', function () {
                            ...
                            // Membres du Bureau
                            document.getElementById('btnAddMembreBureau').addEventListener('click', function () {
                            ...
                            // Adhérents
                            document.getElementById('btnAddAdherent').addEventListener('click', function () {
                            ...
                            document.getElementById('createDossierForm').addEventListener('submit', function (e) {
                                ...
                                document.querySelectorAll('#createDossierForm select[disabled]').forEach(function (select) {
