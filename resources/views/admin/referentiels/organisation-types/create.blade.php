...
@section('title', 'Créer un type d\'organisation')
...
<div class="container-fluid">
    ...
    <form method="POST" action="{{ route('admin.referentiels.organisation-types.store') }}" id="create-form">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3"
                                      placeholder="Description détaillée du type d'organisation...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('icone') is-invalid @enderror" 
                                    ...
                                    @foreach($icones as $class => $label)
                                        <option value="{{ $class }}" {{ old('icone') === $class ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('nb_min_fondateurs_majeurs', 2) }}" 
                                       min="1"
                                       max="100"
                                       required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('nb_min_adherents_creation', 10) }}" 
                                       min="1"
                                       max="10000"
                                       required>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('guide_creation') is-invalid @enderror" 
                                      ...
                                      name="guide_creation" 
                                      rows="5"
                                      placeholder="Étapes et instructions pour la création...">{{ old('guide_creation') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('texte_legislatif') is-invalid @enderror" 
                                      ...
                                      rows="6"
                                      placeholder="Texte de la loi ou extrait pertinent...">{{ old('texte_legislatif') }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ========================================
    let documentIndex = {{ old('documents') ? count(old('documents')) : 0 }};
