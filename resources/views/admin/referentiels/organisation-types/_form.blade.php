{{--
    PARTIEL FORMULAIRE - Types d'organisations
    Utilisé par create.blade.php et edit.blade.php
    
    Variables attendues :
    - $organisationType (null en création, objet en édition)
    - $documentTypes (collection)
    - $couleurs (array)
    - $icones (array)
    - $attachedDocuments (collection, optionnel)
--}}

@php
    $isEdit = isset($organisationType) && $organisationType->exists;
    $actionRoute = $isEdit 
        ? route('admin.referentiels.organisation-types.update', $organisationType->id)
        : route('admin.referentiels.organisation-types.store');
    $actionMethod = $isEdit ? 'PUT' : 'POST';
@endphp

<form method="POST" action="{{ $actionRoute }}" id="{{ $isEdit ? 'edit' : 'create' }}-form">
    @csrf
    @if($isEdit)
        @method('PUT')
    @endif
    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="code" class="form-label">
                            ...
                            <i class="fas fa-info-circle text-muted" data-bs-toggle="tooltip" 
                               title="Code unique en minuscules et underscores (ex: association, parti_politique)"></i>
                        </label>
                        <input type="text" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="3"
                                  placeholder="Description détaillée du type d'organisation...">{{ old('description', $organisationType->description ?? '') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="color" 
                                       ...
                                       id="couleur" 
                                       name="couleur" 
                                       value="{{ old('couleur', $organisationType->couleur ?? '#007bff') }}"
                                       required>
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input @error('is_lucratif') is-invalid @enderror" 
                                       ...
                                       id="non_lucratif" 
                                       value="0" 
                                       {{ old('is_lucratif', isset($organisationType) && $organisationType->is_lucratif ? '1' : '0') == '0' ? 'checked' : '' }}
                                       required>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input @error('is_lucratif') is-invalid @enderror" 
                                       ...
                                       id="lucratif" 
                                       value="1"
                                       {{ old('is_lucratif', isset($organisationType) && $organisationType->is_lucratif ? '1' : '0') == '1' ? 'checked' : '' }}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('nb_min_fondateurs_majeurs', $organisationType->nb_min_fondateurs_majeurs ?? 2) }}" 
                                   min="1"
                                   max="100"
                                   required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('nb_min_adherents_creation', $organisationType->nb_min_adherents_creation ?? 10) }}" 
                                   min="1"
                                   max="10000"
                                   required>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('guide_creation') is-invalid @enderror" 
                                  ...
                                  name="guide_creation" 
                                  rows="5"
                                  placeholder="Étapes et instructions pour la création...">{{ old('guide_creation', $organisationType->guide_creation ?? '') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               placeholder="Loi 016/2025 du 15 octobre">
                        @error('loi_reference')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('texte_legislatif') is-invalid @enderror" 
                                  ...
                                  rows="6"
                                  placeholder="Texte de la loi ou extrait pertinent...">{{ old('texte_legislatif', $organisationType->texte_legislatif ?? '') }}</textarea>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3">
                        Sélectionnez les documents que les organisations de ce type devront fournir lors de leur demande.
                    </p>

                    <div id="documents-container">
                        @php
                            $existingDocuments = old('documents');
                            if (!$existingDocuments && $isEdit && isset($organisationType)) {
                                $existingDocuments = $organisationType->documentTypes->map(function($docType) {
                                    return [
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" name="documents[{{ $index }}][is_obligatoire]" required>
                                            <option value="1" {{ ($document['is_obligatoire'] ?? 1) == '1' ? 'selected' : '' }}>Obligatoire</option>
                                            <option value="0" {{ ($document['is_obligatoire'] ?? 1) == '0' ? 'selected' : '' }}>Facultatif</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-12 mt-2">
                                        ...
                                        <textarea class="form-control" name="documents[{{ $index }}][aide_texte]" rows="2" 
                                                  placeholder="Instructions spécifiques pour ce document...">{{ $document['aide_texte'] ?? '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        @endforeach
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" 
                                   ...
                                   name="is_active" 
                                   value="1"
                                   {{ old('is_active', $organisationType->is_active ?? '1') == '1' ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" 
                               ...
                               id="ordre" 
                               name="ordre" 
                               value="{{ old('ordre', $organisationType->ordre ?? 0) }}" 
                               min="0">
                        @error('ordre')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
            ...
            @if($isEdit && isset($organisationType))
            ...
            @else
                ...
                <div class="card border-info mb-4">
                    ...
                    <div class="card-body">
                        <h6 class="text-info">Format du code</h6>
                        <p class="small">Le code doit être unique, en minuscules, et peut contenir des underscores.</p>
                        <p class="small mb-3"><strong>Exemples :</strong><br>
                            <code>association</code><br>
                            <code>parti_politique</code><br>
                            <code>confession_religieuse</code>
                        </p>

                        <h6 class="text-info">Couleur et icône</h6>
                        <p class="small mb-0">Utilisés pour l'affichage visuel dans l'interface. Choisissez des couleurs distinctives pour chaque type.</p>
                    </div>
                </div>
            @endif
            ...
            <div class="card">
                <div class="card-body">
                    <button type="submit" class="btn btn-{{ $isEdit ? 'warning' : 'primary' }} w-100 mb-2">
            ...
            const template = `
                <div class="document-item border rounded p-3 mb-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 mt-2">
                            <label class="form-label">Aide/Instructions</label>
                            <textarea class="form-control" name="documents[${documentIndex}][aide_texte]" rows="2" 
                                      placeholder="Instructions spécifiques pour ce document..."></textarea>
                        </div>
                    </div>
                </div>
            `;
