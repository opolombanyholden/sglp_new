        ...
        <div class="col-md-3 mb-3">
            <div class="card h-100 border-0 shadow-sm stats-card" style="background: linear-gradient(135deg, #8b1538 0%, #c41e3a 100%);">
                <div class="card-body text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="mb-1">{{ \App\Models\User::where('role', 'operator')->where('created_at', '>=', now()->startOfWeek())->count() }}</h3>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           placeholder="Nom, email, téléphone, NIP...">
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <select name="is_active" class="form-select border-0 bg-light">
                                    ...
                                    <option value="1" {{ request('is_active') === '1' ? 'selected' : '' }}>Compte actif</option>
                                    <option value="0" {{ request('is_active') === '0' ? 'selected' : '' }}>Compte désactivé</option>
                                </select>
                            </div>
                            <div class="col-md-2">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 pt-4 pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-primary">{{ isset($operators) ? $operators->total() : 0 }} opérateurs</span>
                    </div>
                </div>
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    @endif
                                                    <small class="text-muted">Inscrit {{ $operator->created_at->format('d/m/Y') }}</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
            ...
            <div class="modal-body">
                ...
                <form id="statusForm">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="statusReason" name="reason" rows="3" placeholder="Raison du changement de statut..."></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
