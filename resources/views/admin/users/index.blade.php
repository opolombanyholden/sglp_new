...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-2-5 mb-3">
            <div class="card h-100 border-0 shadow-sm stats-card" style="background: linear-gradient(135deg, #6f42c1 0%, #5a32a3 100%);">
                <div class="card-body text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('admin.users.create') }}" class="card h-100 text-decoration-none quick-action-card">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('admin.users.operators') }}" class="card h-100 text-decoration-none quick-action-card">
                                <div class="card-body text-center">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('admin.users.agents') }}" class="card h-100 text-decoration-none quick-action-card">
                                <div class="card-body text-center">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('admin.users.export.excel') }}" class="card h-100 text-decoration-none quick-action-card">
                                <div class="card-body text-center">
                    ...
                    <form method="GET" action="{{ route('admin.users.index') }}" class="row g-3 align-items-end">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="search" class="form-control form-control-lg" 
                                   placeholder="Nom, email, NIP, téléphone..." 
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="role" class="form-select form-select-lg">
                                ...
                                <option value="operator" {{ request('role') === 'operator' ? 'selected' : '' }}>Opérateur</option>
                                <option value="new_system" {{ request('role') === 'new_system' ? 'selected' : '' }}>Système avancé</option>
                            </select>
                        </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr class="user-row">
                                        ...
                                        <td>
                                            @if($user->roleModel)
                                            <span class="badge" style="background: linear-gradient(135deg, #6f42c1, #5a32a3); color: white;" 
                                                  title="Système avancé de rôles">
                                                {{ $user->roleModel->display_name }}
                                            </span>
                                            @else
                                            <span class="badge {{ $user->role === 'admin' ? 'bg-danger' : ($user->role === 'agent' ? 'bg-warning text-dark' : 'bg-primary') }}">
                                                {{ ucfirst($user->role) }}
                                            </span>
                                            @endif
                                        </td>
                                        <td>
                                            ...
                                            @endphp
                                            <span class="badge {{ $status === 'active' ? 'bg-success' : ($status === 'suspended' ? 'bg-danger' : 'bg-secondary') }}">
                                                @if($status === 'active') 
