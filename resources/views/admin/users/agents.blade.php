                ...
                <div class="card-body text-white">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="mb-0 opacity-90">Supervision et coordination de l'équipe d'agents de validation</p>
                        </div>
            ...
            <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, rgba(255, 205, 0, 0.1), rgba(255, 205, 0, 0.05));">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-end">
                            <span class="badge bg-warning text-dark">{{ $agents->where('availability', 'Disponible')->count() }} disponibles</span>
                        </div>
                    </div>
                    <div class="mt-3">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <div class="d-flex align-items-center bg-white rounded-pill px-3 py-2 shadow-sm">
                                ...
                                <span class="badge bg-light text-dark ms-2">{{ $availableAgent->current_workload ?? 0 }}</span>
                            </div>
                            @empty
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-0 bg-light" placeholder="Rechercher un agent..." id="searchInput">
                            </div>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="btn-group" role="group">
                                ...
                                <button onclick="exporterSelection()" class="btn btn-outline-primary" disabled id="btnExporter">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr class="agent-row">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="agent-avatar me-3">
                                                    ...
                                                    <div class="position-relative">
                                                        <div class="rounded-circle bg-success text-white d-flex align-items-center justify-content-center" style="width: 45px; height: 45px; font-weight: bold;">
                                                            {{ $initials }}
                                                        </div>
                                                        @if($isOnline)
                                                        <div class="position-absolute bottom-0 end-0">
                                                            <span class="badge bg-success rounded-pill" style="width: 12px; height: 12px; padding: 0;"></span>
                                                        </div>
                                                        @endif
                                                    </div>
                                                </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="progress me-2" style="width: 60px; height: 8px;">
                                                    <div class="progress-bar bg-{{ $level }}" style="width: {{ $percentage }}%"></div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button type="button" class="btn btn-sm btn-outline-primary" onclick="voirAgent({{ $agent->id }})" title="Voir détails">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button type="button" class="btn btn-sm btn-outline-success" onclick="modifierAgent({{ $agent->id }})" title="Modifier">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                @if($availability === 'Disponible')
                                                <button type="button" class="btn btn-sm btn-outline-warning" onclick="assignationRapide({{ $agent->id }})" title="Assigner dossier">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="#" onclick="changerStatut({{ $agent->id }})">
                                                            <i class="fas fa-toggle-on me-2"></i>Changer statut
                                                        </a></li>
                                                        <li><a class="dropdown-item" href="#" onclick="reinitialiserMotDePasse({{ $agent->id }})">
                                                            <i class="fas fa-key me-2"></i>Réinitialiser mot de passe
                                                        </a></li>
                                                        <li><a class="dropdown-item" href="#" onclick="voirStatistiques({{ $agent->id }})">
                                                            <i class="fas fa-chart-bar me-2"></i>Statistiques
                                                        </a></li>
                                                        <li><hr class="dropdown-divider"></li>
                                                        <li><a class="dropdown-item text-danger" href="#" onclick="supprimerAgent({{ $agent->id }})">
...
<div class="fab-container">
    <div class="fab-menu" id="fabMenu">
        ...
        <div class="fab-options">
            ...
            <button class="fab-option" style="background: #ffcd00; color: #000;" title="Assigner agents" onclick="assignerDossiers()">
                <i class="fas fa-tasks"></i>
            </button>
            <button class="fab-option" style="background: #003f7f;" title="Exporter données" onclick="exporterDonnees()">
