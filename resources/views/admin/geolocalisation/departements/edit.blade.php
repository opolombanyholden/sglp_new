{{-- resources/views/admin/geolocalisation/departements/edit.blade.php --}}
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <nav aria-label="breadcrumb" class="mt-2">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.geolocalisation.departements.show', $departement) }}">{{ $departement->nom }}</a>
                            </li>
                ...
                <div>
                    <a href="{{ route('admin.geolocalisation.departements.show', $departement) }}" class="btn btn-info me-2">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.geolocalisation.departements.update', $departement) }}" novalidate>
                        @csrf
                        @method('PUT')
